...
Public Class Main
    ...
    Private Sub FindUplink()
        ...
        For Each FileName As String In files
            ...
            If str = "Uplink" Then
                ...
                'MsgBox(FileName.Substring(FileName.Length - 15, 11))
            End If
        Next
    End Sub
    ...
    End Sub
    Private Sub InputNumberCheck(sender As Object, e As KeyPressEventArgs) Handles UserID.KeyPress, DeviceID.KeyPress, MaxRunText.KeyPress, MinThreshold.KeyPress, MaxThreshold.KeyPress, RainID.KeyPress, UploadInterval.KeyPress, IrrigInterval.KeyPress
